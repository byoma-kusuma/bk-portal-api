...
import { PasswordTokenAvgOrderByAggregateInput } from './password-token-avg-order-by-aggregate.input';
...
import { PasswordTokenSumOrderByAggregateInput } from './password-token-sum-order-by-aggregate.input';
...
export class PasswordTokenOrderByWithAggregationInput {
    ...
    @Field(() => PasswordTokenAvgOrderByAggregateInput, {nullable:true})
    _avg?: PasswordTokenAvgOrderByAggregateInput;
    ...
    @Field(() => PasswordTokenSumOrderByAggregateInput, {nullable:true})
    _sum?: PasswordTokenSumOrderByAggregateInput;
}
